<template>
    <footer class="bg-slate-800 border-t border-gray-300 p-8 text-center">
        <div class="mb-6 text-lg">
            <nuxt-link to="/page1" class="text-white hover:text-emerald-500 font-bold text-xl comfortaa">Tommorow Coding</nuxt-link>
        </div>
        <nav class="flex flex-row justify-center gap-4 text-white">
